<template>
  <section class="p-faq p-default-block">
    <bread-crumbs/>
    <div class="container">
      ...
      <div class="faq-item">
        <h2 class="g-caption-section">Гарантии безопасности</h2>
        <div class="editor">
          <p>
      ...
      <div class="faq-item">
        <h2 class="g-caption-section">Безопасность онлайн-платежей</h2>
        <div class="editor">
          <p>
          ...
          <p>
            Мы рекомендуем вам проверить, что ваш браузер достаточно безопасен для проведения платежей онлайн, на
            <a href="https://my.cloudpayments.ru/ru/browser">специальной странице</a>
          </p>
          <p>
      ...
      <div class="faq-item">
        <h2 class="g-caption-section">Получение товара</h2>
        <div class="editor">
          <p>После оплаты билета вы получаете его на указанную вами электронную почту. Для прохода на мероприятия достаточно распечатать билет или показать его с экрана мобильного телефона для сканирования QR кода билета.</p>
        </div>
      </div>
      <div class="faq-item">
        <h2 class="g-caption-section">Возврат денежных средств</h2>
        <div class="editor">
          ...
          <ol>
            <li>Потребитель вправе отказаться от товара в любое время до его передачи, после передачи товара отказ необходимо оформить в течение 14 дней, но не позже, чем за сутки до мероприятия;</li>
            ...
            <li>При отказе от товара со стороны потребителя продавец должен вернуть ему денежную сумму, уплаченную потребителем, не позднее чем через десять рабочих дней со дня предъявления потребителем соответствующего требования.</li>
          </ol>
          <p>Для возврата денежных средств на банковскую карту необходимо заполнить «Заявление о возврате денежных средств», которое высылается по требованию компанией на электронный адрес, и отправить его вместе с приложением копии документа, удостоверяющего личность, по адресу
            <a href="mailto:info@businessof.life">info@businessof.life</a>.</p>
          ...
          <p>Для возврата денежных средств по операциям, проведенным с ошибками, необходимо обратиться с письменным заявлением и приложением копии документа, удостоверяющего личность, и чеков/квитанций, подтверждающих ошибочное списание. Данное заявление необходимо направить по адресу <a href="mailto:info@businessof.life">info@businessof.life</a>.
          </p>
      ...
      <div class="faq-item">
        <h2 class="g-caption-section">Случаи отказа в совершении платежа:</h2>
        <div class="editor">
          <ul>
            ...
            <li>недостаточно средств для оплаты на банковской карте. Подробнее о наличии средств на платежной карте Вы можете узнать, обратившись в банк, выпустивший банковскую карту;
            </li>
          ...
          <p>По вопросам оплаты с помощью банковской карты и иным вопросам, связанным с работой сайта, Вы можете обратиться по следующему телефону: +7 (707) 235-03-07.</p>
        </div>
      </div>
      <div class="faq-item">
        <h2 class="g-caption-section">Конфиденциальность</h2>
        <div class="editor">
          <p>1. Определения</p>
          <p>Интернет проект <a href="https://www.businessof.life/" target="_blank">www.businessof.life</a> (далее – URL, «мы») серьезно относится к вопросу конфиденциальности информации своих клиентов и посетителей сайта <a href="https://www.businessof.life/" target="_blank">www.businessof.life</a> (далее – «вы», «посетители сайта»). Персонифицированной мы называем информацию, содержащую персональные данные (например: ФИО, логин или название компании) посетителя сайта, а также информацию о действиях, совершаемых вами на сайте URL. (например: заказ посетителя сайта с его контактной информацией). Анонимными мы называем данные, которые невозможно однозначно идентифицировать с конкретным посетителем сайта (например: статистика посещаемости сайта).</p>
          ...
          <p>3. Ссылки</p>
          <p>Сайт <a href="https://www.businessof.life/" target="_blank">www.businessof.life</a> может содержать ссылки на другие сайты, не имеющие отношения к нашей компании и принадлежащие третьим лицам. Мы не несем ответственности за точность, полноту и достоверность сведений, размещенных на сайтах третьих лиц, и не берем на себя никаких обязательств по сохранению конфиденциальности информации, оставленной вами на таких сайтах.
          </p>
          <p>4. Ограничение ответственности</p>
          <p>Мы делаем все возможное для соблюдения настоящей политики конфиденциальности, однако, мы не можем гарантировать сохранность информации в случае воздействия факторов находящихся вне нашего влияния, результатом действия которых станет раскрытие информации. Сайт <a href="https://www.businessof.life/" target="_blank">www.businessof.life</a> и вся размещенная на нем информация представлены по принципу "как есть” без каких-либо гарантий. Мы не несем ответственности за неблагоприятные последствия, а также за любые убытки, причиненные вследствие ограничения доступа к сайту URL или вследствие посещения сайта и использования размещенной на нем информации.
          </p>
          <p>5. Контакты</p>
          <p>По вопросам, касающимся настоящей политики, просьба обращаться по адресу <a href="mailto:info@businessof.life">info@businessof.life</a></p>
        </div>
      </div>
      <div class="faq-item">
        <h2 class="g-caption-section">Юридическое лицо</h2>
        <div class="editor">
          <p>TОО "Business of Life" , Казахстан, г. Алматы, Алмалинский р-н, ул. Айтиева зд. 96</p>
        </div>
      </div>
    </div>
  </section>
