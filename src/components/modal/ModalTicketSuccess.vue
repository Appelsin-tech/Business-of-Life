    ...
    <div class="modal modal__ticket-success">
      <div class="modal__container modal__container--ticket-success">
        ...
        <div class="info">
          ...
          <div class="text" v-if="ticketArr[0].event.type !== 2">
          ...
          <div class="text" v-else>
            <p>Ссылка для входа на вебинар была отправлена на {{email}}.</p>
            <p>Чтобы попасть на вебинар, пройдите по ссылке из письма и нажмите "подключиться".</p>
          </div>
        </div>
      </div>
    </div>
